...
if USE_MOCK_AUTH:
    ...
    def login():
        return jsonify({"message": "This is a mock login route for Outlook."})

    @auth_outlook.route("/auth/outlook/callback")
    def callback():
        return jsonify({"message": "This is a mock callback route for Outlook."})

    @auth_outlook.route("/auth/outlook/logout")
    def logout():
        return jsonify({"message": "This is a mock logout route for Outlook."})
